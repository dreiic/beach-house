...
const siteContent = {
  mne: {
    ...
    experience: {
      ...
      imageAltTop: "Pogled sa terase prema dvorištu i moru",
      imageAltBottom: "Bungalovi između borove šume i plaže",
      imageAltSmall: "Jutarnji ambijent na terasi",
    },
    testimonials: {
    ...
    gallery: {
      ...
      alt: [
        "Prelijepi pogled na plažu i borovu šumu sa terase",
        "Pogled na plažu i borovu šumu iz vazduha",
        "Čardak VIP apartman, spojen od dva apartmana",
        "Duga drvena terasa prema dvorištu",
        "Terasa povezana sa spavaćom sobom",
        "Spavaća soba sa drvenim plafonom",
        "Spoljašnja uslužna kuhinja i posuđe",
        "Spavaća soba iz jedne od prelijepih kuća",
        "Terasa sa ljuljaškom za opuštanje",
        "Terasa u noćnom ambijentu",
        "Svijetlo privatno kupatilo",
        "Sunčano dvorište između bungalova",
        "Bungalovi osvijetljeni uveče",
      ],
    },
    how: {
      title: "Rezervacija",
    ...
    footer: {
      ...
      contact: "Kontakt",
      phone: "+382 63 461 761",
      phoneHref: "tel:+38263461761",
  ...
  eng: {
    ...
    experience: {
      ...
      imageAltTop: "View from the terrace toward the yard and sea",
      imageAltBottom: "Bungalows between the pine forest and beach",
      imageAltSmall: "Morning atmosphere on the terrace",
    },
    testimonials: {
    ...
    gallery: {
      ...
      alt: [
        "Beautiful view of the beach and pine forest from the terrace",
        "Aerial view of the beach and pine forest",
        "Čardak VIP apartment, joined from two apartments",
        "Long wooden terrace facing the yard",
        "Terrace connected to the bedroom",
        "Bedroom with a wooden ceiling",
        "Outdoor service kitchen and dishes",
        "Bedroom from one of the amazing houses",
        "Terrace with a swing for relaxing",
        "Terrace in a peaceful nighttime ambiance",
        "Bright private bathroom",
        "Sunny yard between the bungalows",
        "Bungalows lit in the evening",
      ],
    },
    how: {
      title: "Booking",
