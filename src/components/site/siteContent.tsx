...
const siteContent = {
  mne: {
    ...
    gallery: {
      ...
      alt: [
        "Bungalovi i borovi otvoreni prema plaži",
        ...
        "Bungalovi osvijetljeni među borovima",
        "Plava spavaća soba sa pogledom",
        "Miran detalj terase u prirodnom hladu",
  ...
  eng: {
    ...
    gallery: {
      ...
      alt: [
        "Bungalows and pine trees opening toward the beach",
        ...
        "Bungalows lit among the pine trees",
        "Blue bedroom with a view",
        "Quiet terrace detail in natural shade",
